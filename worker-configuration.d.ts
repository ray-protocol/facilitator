/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 77b542e31ec51200f05d62c083135a46)
...
interface __BaseEnv_CloudflareBindings {
	...
	FLARE_MAINNET_RPC_URL: string;
	FLARE_TESTNET_RPC_URL: string;
	SONGBIRD_MAINNET_RPC_URL: string;
	SONGBIRD_TESTNET_RPC_URL: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FACILITATOR_PRIVATE_KEY" | "FLARE_MAINNET_RPC_URL" | "FLARE_TESTNET_RPC_URL" | "SONGBIRD_MAINNET_RPC_URL" | "SONGBIRD_TESTNET_RPC_URL">> {}
}
